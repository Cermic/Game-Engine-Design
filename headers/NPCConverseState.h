...
class NPCConverseState :public PlayerState // Inherits from player state to get the apprpriate links methods
{
public:
	NPCConverseState();//class constructor
	virtual ~NPCConverseState() {}//virtual destructor
