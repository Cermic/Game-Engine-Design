...
class TravellingState : public PlayerState // Inherits from player state to get the apprpriate links methods
{
public:
	TravellingState();//class constructor
	virtual ~TravellingState() {}//virtual destructor
