...
class BattleState :public PlayerState // Inherits from player state to get the apprpriate links methods
{
public:
	BattleState();//class constructor
	virtual ~BattleState() {}//virtual destructor
