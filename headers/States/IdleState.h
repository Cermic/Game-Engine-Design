...
class IdleState : public PlayerState // Inherits from player state to get the apprpriate links methods
{
public:
	IdleState();//class constructor
	virtual ~IdleState() {}//virtual destructor
