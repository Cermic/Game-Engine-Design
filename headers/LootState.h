...
class LootState :public PlayerState // Inherits from player state to get the apprpriate links methods
{
public:
	LootState();//class constructor
	virtual ~LootState() {}//virtual destructor
