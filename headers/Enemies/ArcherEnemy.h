...
class ArcherEnemy : public AbstractEnemyNPC
{
public:
	ArcherEnemy(std::string fn, std::string theType) : AbstractEnemyNPC(fn, theType) {} //constructor follows abstractEnemyNPC constructor
	virtual ~ArcherEnemy() {};
...
private:
	float damage = 10;  //defined damage property for the type of enemy
};