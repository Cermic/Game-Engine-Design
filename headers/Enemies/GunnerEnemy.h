...
class GunnerEnemy : public AbstractEnemyNPC
{
public:
	GunnerEnemy(std::string fn, std::string theType) : AbstractEnemyNPC(fn, theType) {} //constructor follows abstractEnemyNPC constructor
	virtual ~GunnerEnemy() {};
...
private:
	float damage = 15;  //defined damage property for the type of enemy
};